...
LABEL RUN="/usr/bin/docker run --interactive --tty --rm --privileged --net=host --ipc=host --pid=host --volume /run:/run --volume /var/log:/var/log --volume /etc/docker_autotest:/usr/local/autotest/client/tests/docker/config_custom --volume /var/log/docker_autotest:/usr/local/autotest/client/results --volume /var/lib/docker_autotest/pretests:/usr/local/autotest/client/tests/docker/pretests/custom --volume /var/lib/docker_autotest/subtests:/usr/local/autotest/client/tests/docker/subtests/custom --volume /var/lib/docker_autotest/intratests:/usr/local/autotest/client/tests/docker/intratests/custom --volume /var/lib/docker_autotest/posttests:/usr/local/autotest/client/tests/docker/posttests/custom --name docker_autotest docker_autotest"
